...
scenario('"Geolocation by IP Address"', () => {
    ...
    scenario('Change Geolocation by IP address', client => {
      ...
      test('should Put the file in /app/Resources/geoip', () => client.moveFile(global.downloadsFolderPath, global.downloadedFileName, global.projectTestDir+"app/Resources/geoip/"));
      ...
      test('should delete the file from /app/Resources/geoip', () => client.deleteFile(global.downloadedFileName,global.projectTestDir+"app/Resources/geoip/"));
