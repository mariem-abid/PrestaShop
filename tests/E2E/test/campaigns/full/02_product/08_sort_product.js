...
scenario('Check the sort of products in the Back Office', client => {
  ...
  /* common_scenarios.sortProduct(ProductList.product_id, 'id_product');
   ...
   common_scenarios.sortProduct(ProductList.product_category, 'category');
   common_scenarios.sortProduct(ProductList.product_price, 'price');
   common_scenarios.sortProduct(ProductList.product_quantity, 'quantity');
   common_scenarios.sortProduct(ProductList.product_status, 'status');
...
scenario('Search products by different attributes', client => {
