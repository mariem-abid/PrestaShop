module.exports = {
  AddProductPage: {
    ...
    catalog_reset_filter: '//*[@id="product_catalog_list"]//button[@type="reset"]',
  ...
  ProductList: {
    ...
    product_category: '//*[@id="product_catalog_list"]//tbody/tr[%ID]/td[5]',
    product_price: '//*[@id="product_catalog_list"]//tbody/tr[%ID]/td[6]',
    product_quantity: '//*[@id="product_catalog_list"]//tbody/tr[%ID]/td[7]',
    product_status: '//*[@id="product_catalog_list"]//tbody/tr[%ID]/td[8]',
    sort_by_icon: '//*[@id="product_catalog_list"]//thead//div[@data-sort-col-name="%B" and @data-sort-direction="%w"]',//sort_by_icon: '//*[@id="product_catalog_list"]//thead//span[@psorderby="%B" and @psorderway="%W"]',
