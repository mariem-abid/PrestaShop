module.exports = {
  CheckoutOrderPage: {
    ...
    block_cart: '//*[@id="blockcart-modal"]',
    cart_container: '//*[@id="main"]//div[@class="card cart-container"]',
    quantity_button: '//*[@id="main"]//button[contains(@class,"%WORD-product-quantity")]',
    remove_button: '//*[@id="main"]//a[@class="remove-from-cart"]',
    cart_item: '//*[@id="main"]//ul[@class="cart-items"]'
  }
};
