module.exports = {
  DiscountSubMenu: {
    catalogPriceRules: {
      catalog_price_rules_subtab: '#subtab-AdminSpecificPriceRule',
      ...
      search_name_input:'#table-specific_price_rule  input[name="specific_price_ruleFilter_a!name"]',
      search_button:'#submitFilterButtonspecific_price_rule',
      dropdown_button:'#table-specific_price_rule  tr:nth-child(1)  button[data-toggle="dropdown"]',
      delete_button:'#form-specific_price_rule a[class*=delete]',
      success_delete_message:'#content  div:nth-child(6) div[class*=alert-success]'
    },
    cartRules: {
      ...
      first_result_option: 'li[class="ac_even ac_over"]',// selector to click on the first result option(customer or product)
      ...
      search_name_input:'#form-cart_rule input[name*=cart_ruleFilter_name]',
      search_button:'#submitFilterButtoncart_rule',
      dropdown_button:'#form-cart_rule  tr:nth-child(1)  button[data-toggle="dropdown"]',
      delete_button:'#form-cart_rule a[class*=delete]',
      success_delete_message:'#content > div.bootstrap > div[class*=success]',
      filter_name_input: '#form-cart_rule input[name*=cart_ruleFilter_name]',
